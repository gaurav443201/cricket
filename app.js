...
const STATE = {
  ...
  // Player stats
  striker: { name: 'Ruturaj Gaikwad (c)', runs: 0, balls: 0, fours: 0, sixes: 0, initials: 'RG' },
  nonStriker: { name: 'Urvil Patel', runs: 0, balls: 0, fours: 0, sixes: 0, initials: 'UP' },
  bowler: { name: 'Josh Hazlewood', overs: 0, legalBalls: 0, runs: 0, wickets: 0, wides: 0, nb: 0, initials: 'JH' },
...
function initSettings() {
  ...
  if (tgtInput) tgtInput.value = STATE.target;
